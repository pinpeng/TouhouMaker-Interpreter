...
if (!script_exists(_i)) {
    ...
    __execute_print_string += "\nexecute string: " + "Unsupported function for function_execute: " + string(_n);
    return;
}

var _args = array_create(16, undefined);
...
if (!script_exists(_i)) {
    ...
    __execute_print_string += "\nexecute string: " + "Unsupported function for function_execute_array: " + string(_n);
    return;
}

var _args = (argument_count > 1) ? argument[1] : array_create(16, undefined);

if(argument_count > 1) {
    for(var i = 0; i < 16; i ++) {
        if(array_length(argument[1]) <= i) {
            _args[i] = undefined;
        }
    }
}
...
#define __function_execute_1512678626657_help
__execute_print_string += "\nGameMaker Language (GML) is only using in GameMaker." + "\n" + 
"Type url_open(\"https://manual.gamemaker.io\") to get more information." + "\n" +
"You can type any function in GameMaker for executing, including custom function." + "\n" +
"Exp.1 instance_create_depth(10, 10, 0, Obj_exec) , this will create Obj_exec in coord(10, 10, 0)." + "\n" + 
"Exp.2 setting_set(\"global\", \"debug\", 1) , this will open debug mode." + "\n" + 
"Type <global variable name> to access global variable (if exists)." + "\n" +
"Exp. BASE_RESOLUTION_RATIO_WIDTH , the result should be \"1280\" (as default)." + "\n" + 
"Type <variable name> to access local variable or member variable (if exists)." + "\n" +
"Exp. a , the result should be \"{ b : { c : 114514 } }\"" + "\n" + 
"Type var <variable name> to create local variable, the variable persists until the end of the line." + "\n" +
"Exp. var tmp = 1 tmp ++ tmp , it will be spearate to three parts, the result should be \"1, 2, 2\" ." + "\n" + 
"Type <object assest>.<variable name> to access member variable." + "\n" +
"Exp. Cmd_systemConsolo.a.b.c , the result should be \"114514\" ." + "\n" + 
"Type any valid formula for variable control. " + "\n" +
"Exp.1 Obj_exec.x += 10" + "\n" + 
"Exp.2 Obj_exec.abc = Obj_exec.y" + "\n" + 
"Press [Up] and [Down] to access historical records." + "\n" + 
"Press [F1] to close consolo window. Type help() to get help, cls() to clean message.";
return;
...
var _a = argument[0];
instance_change(_a[0],_a[1]);
return undefined;
#define __function_execute_1512678626657_instance_destroy
var _a = argument[0];
switch(array_length_1d(_a)) {
    case 0: instance_destroy(); return undefined;
    case 1: instance_destroy(_a[0]); return undefined;
    case 2: instance_destroy(_a[0],_a[1]); return undefined;
    case 3: instance_destroy(_a[0],_a[1],_a[2]); return undefined;
    case 4: instance_destroy(_a[0],_a[1],_a[2],_a[3]); return undefined;
    case 5: instance_destroy(_a[0],_a[1],_a[2],_a[3],_a[4]); return undefined;
    case 6: instance_destroy(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5]); return undefined;
    case 7: instance_destroy(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6]); return undefined;
    case 8: instance_destroy(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7]); return undefined;
    case 9: instance_destroy(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8]); return undefined;
    case 10: instance_destroy(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9]); return undefined;
    case 11: instance_destroy(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10]); return undefined;
    case 12: instance_destroy(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11]); return undefined;
    case 13: instance_destroy(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12]); return undefined;
    case 14: instance_destroy(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12],_a[13]); return undefined;
    case 15: instance_destroy(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12],_a[13],_a[14]); return undefined;
    case 16: instance_destroy(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12],_a[13],_a[14],_a[15]); return undefined;
}
return undefined;
...
var _a = argument[0];
event_perform_object(_a[0],_a[1],_a[2]);
return undefined;
...
#define __function_execute_1512678626657_print
var _a = argument[0];
__execute_print_string += "\n" + string(_a[0]);
return __execute_print_string;
#define __function_execute_1512678626657_cls
__execute_print_string = "";
return __execute_print_string;
...
var _a = argument[0];
draw_sprite(_a[0],_a[1],_a[2],_a[3]);
return undefined;
...
var _a = argument[0];
draw_sprite_ext(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8]);
return undefined;
...
var _a = argument[0];
draw_sprite_part(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7]);
return undefined;
...
var _a = argument[0];
draw_rectangle(_a[0],_a[1],_a[2],_a[3],_a[4]);
return undefined;
...
var _a = argument[0];
draw_point_colour(_a[0],_a[1],_a[2]);
return undefined;
#define __function_execute_1512678626657_draw_line_colour
var _a = argument[0];
draw_line_colour(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5]);
return undefined;
...
var _a = argument[0];
draw_point_color(_a[0],_a[1],_a[2]);
return undefined;
...
var _a = argument[0];
sprite_set_cache_size(_a[0],_a[1]);
return undefined;
...
var _a = argument[0];
switch(array_length_1d(_a)) {
    case 0: ds_stack_push(); return undefined;
    case 1: ds_stack_push(_a[0]); return undefined;
    case 2: ds_stack_push(_a[0],_a[1]); return undefined;
    case 3: ds_stack_push(_a[0],_a[1],_a[2]); return undefined;
    case 4: ds_stack_push(_a[0],_a[1],_a[2],_a[3]); return undefined;
    case 5: ds_stack_push(_a[0],_a[1],_a[2],_a[3],_a[4]); return undefined;
    case 6: ds_stack_push(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5]); return undefined;
    case 7: ds_stack_push(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6]); return undefined;
    case 8: ds_stack_push(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7]); return undefined;
    case 9: ds_stack_push(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8]); return undefined;
    case 10: ds_stack_push(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9]); return undefined;
    case 11: ds_stack_push(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10]); return undefined;
    case 12: ds_stack_push(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11]); return undefined;
    case 13: ds_stack_push(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12]); return undefined;
    case 14: ds_stack_push(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12],_a[13]); return undefined;
    case 15: ds_stack_push(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12],_a[13],_a[14]); return undefined;
    case 16: ds_stack_push(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12],_a[13],_a[14],_a[15]); return undefined;
}
return undefined;
...
var _a = argument[0];
ds_grid_set(_a[0],_a[1],_a[2],_a[3]);
return undefined;
...
var _a = argument[0];
switch(array_length_1d(_a)) {
    case 0: shader_set_uniform_i(); return undefined;
    case 1: shader_set_uniform_i(_a[0]); return undefined;
    case 2: shader_set_uniform_i(_a[0],_a[1]); return undefined;
    case 3: shader_set_uniform_i(_a[0],_a[1],_a[2]); return undefined;
    case 4: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3]); return undefined;
    case 5: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3],_a[4]); return undefined;
    case 6: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5]); return undefined;
    case 7: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6]); return undefined;
    case 8: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7]); return undefined;
    case 9: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8]); return undefined;
    case 10: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9]); return undefined;
    case 11: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10]); return undefined;
    case 12: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11]); return undefined;
    case 13: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12]); return undefined;
    case 14: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12],_a[13]); return undefined;
    case 15: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12],_a[13],_a[14]); return undefined;
    case 16: shader_set_uniform_i(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12],_a[13],_a[14],_a[15]); return undefined;
}
return undefined;
...
var _a = argument[0];
switch(array_length_1d(_a)) {
    case 0: shader_set_uniform_f(); return undefined;
    case 1: shader_set_uniform_f(_a[0]); return undefined;
    case 2: shader_set_uniform_f(_a[0],_a[1]); return undefined;
    case 3: shader_set_uniform_f(_a[0],_a[1],_a[2]); return undefined;
    case 4: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3]); return undefined;
    case 5: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3],_a[4]); return undefined;
    case 6: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5]); return undefined;
    case 7: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6]); return undefined;
    case 8: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7]); return undefined;
    case 9: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8]); return undefined;
    case 10: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9]); return undefined;
    case 11: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10]); return undefined;
    case 12: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11]); return undefined;
    case 13: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12]); return undefined;
    case 14: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12],_a[13]); return undefined;
    case 15: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12],_a[13],_a[14]); return undefined;
    case 16: shader_set_uniform_f(_a[0],_a[1],_a[2],_a[3],_a[4],_a[5],_a[6],_a[7],_a[8],_a[9],_a[10],_a[11],_a[12],_a[13],_a[14],_a[15]); return undefined;
}
return undefined;
